...
HEADER_FILES = [
    ...
    "include/platform.h",
    "include/handlers/createwindowhandler.h",
    "include/handlers/appinfohandler.h",
    "include/handlers/calculatorhandler.h",
    "include/handlers/filedialoghandler.h",
