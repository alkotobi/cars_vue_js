  ...
  <div class="clients-view">
    ...
    <div v-if="showAddDialog" class="dialog-overlay">
      <div class="dialog">
        ...
        <div class="form-group">
          <input v-model="newClient.name" placeholder="Name" class="input-field" />
          <input v-model="newClient.address" placeholder="Address" class="input-field" />
          <input 
          ...
          />
          <input v-model="newClient.mobiles" placeholder="Mobile" class="input-field" />
          <input v-model="newClient.id_no" placeholder="ID No" class="input-field" />
          <div v-if="validationError" class="error-message">{{ validationError }}</div>
        </div>
        <div class="dialog-actions">
          <button @click="addClient" class="btn save-btn">Add</button>
    ...
    <div v-if="showEditDialog" class="dialog-overlay">
      <div class="dialog">
        <h3>Edit Client</h3>
        <div class="form-group">
          <input v-model="editingClient.name" placeholder="Name" class="input-field" />
          <input v-model="editingClient.address" placeholder="Address" class="input-field" />
          <input 
          ...
          />
          <input v-model="editingClient.mobiles" placeholder="Mobile" class="input-field" />
          <input v-model="editingClient.id_no" placeholder="ID No" class="input-field" />
          <div v-if="validationError" class="error-message">{{ validationError }}</div>
        </div>
        <div class="dialog-actions">
          <button @click="updateClient" class="btn save-btn">Save</button>
