...
CREATE TABLE IF NOT EXISTS `sell_bill` (
  ...
  `notes` JSON DEFAULT NULL COMMENT 'JSON array of notes: [{"id_user": int, "note": "text", "timestamp": "datetime"}]',
  `id_user` int DEFAULT NULL,
  ...
  `edited_by` JSON DEFAULT NULL COMMENT 'JSON array tracking edits: [{"id_user": int, "timestamp": "datetime"}]',
